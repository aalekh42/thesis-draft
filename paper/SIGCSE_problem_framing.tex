...
The AI scaffold data offer preliminary support for these instructional implications. Among the 13~completers who entered the scaffolding phase, 77\% of suggestions were accepted. Qualitative inspection suggests acceptance concentrated on components frequently absent from unaided drafts, such as constraints, success criteria, and stakeholder actionability. These preliminary patterns suggest that students often accept cues addressing these gaps, even though the components are routinely omitted without prompting. A systematic breakdown by hint type is planned for the full study. The steep expertise gradient in completion rates (25\% beginners vs.\ 89\% advanced) further suggests that completion may be expertise-sensitive, making scaffold support for beginners especially important.

Three instructional moves follow. First, make problem framing a graded skill with rubrics that separately assess context, objective, constraints, and success criteria. Second, ask students to justify why a prediction is actionable. Third, explicitly prompt for stakeholder use and ethical risks, as these appeared in fewer than half of unaided drafts yet were addressed when directly cued via scaffolds. This analysis has a small sample (32~participants, 19~completers) and one scenario. Only two beginner sessions appear in the coded subset, limiting conclusions about novice framing; recruiting beginners is a priority given their 25\% completion rate. Next steps include a larger balanced sample across multiple scenarios in a pre-registered follow-up.
